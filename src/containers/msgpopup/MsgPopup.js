const DEFAULT_OPTIONS = {
  ...
  onClose: () => {},
  canClose: true,
  showProgress: [true,'sucses']
}

export default class MsgPopup {
  #toastElem
  #autoCloseInterval
  #progressInterval
  #removeBinded
  ...
  set type(value) {
    this.#toastElem.classList.add(`${value}__msg-popup`);
  }
  ...
  set showProgress([value,type]) {
    this.#toastElem.classList.toggle(`progress-${type}`, value)
